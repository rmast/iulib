...
namespace iulib {
    ...
    template void shift_by(bytearray &,int,int,narray_byte);
    ...
    template void circ_by(bytearray &,int,int,narray_byte);
    ...
    template void pad_by(bytearray &,int,int,narray_byte);
    ...
    template void erase_boundary(bytearray &,int,int,narray_byte);
    ...
    template void resize_to(bytearray &,int,int,narray_byte);
